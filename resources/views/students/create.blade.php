            ...
            <div class="card-body">
                ...
                <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('idtype') is-invalid @enderror" id="idtype" name="idtype" required>
                            <option value="{{ App\Models\Student::STUDENT_IDTYPE_TI }}">Tarjeta de Identidad</option>
                            <option value="{{ App\Models\Student::STUDENT_IDTYPE_PASSPORT }}">Pasaporte</option>
                            <option value="{{ App\Models\Student::STUDENT_IDTYPE_DE }}">Documento de Extranjería</option>
                        </select>
                        @error('idtype')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                            <option value="{{ App\Models\Student::STUDENT_GENDER_MALE }}">Masculino</option>
                            <option value="{{ App\Models\Student::STUDENT_GENDER_FEMALE }}">Femenino</option>
                            <option value="{{ App\Models\Student::STUDENT_GENDER_OTHER }}">Otro</option>
                        </select>
                        @error('gender')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('rh') is-invalid @enderror" id="rh" name="rh" value="{{ old('rh') }}" required>
                        @error('rh')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('diseases') is-invalid @enderror" id="diseases" name="diseases" value="{{ old('diseases') }}">
                        @error('diseases')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('father_mobile') is-invalid @enderror" id="father_mobile" name="father_mobile" value="{{ old('father_mobile') }}">
                        @error('father_mobile')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('mother_mobile') is-invalid @enderror" id="mother_mobile" name="mother_mobile" value="{{ old('mother_mobile') }}">
                        @error('mother_mobile')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
